...
object ItemBlockJar extends RegistryHandler[Item] {
...
class ItemBlockJar(block: Block) extends ItemBlockTFC(block) with IItemSize {
  ...
  override def onItemUse(
    ...
    if (this == ItemBlockJar.INSTANCE) {
      ...
      ItemBlockJar.INSTANCE.onItemUse(
        player,
        worldIn,
        pos,
        hand,
  ...
  override def onItemUseFirst(
    ...
    if (this == ItemBlockJar.INSTANCE) {
      ...
      ItemBlockJar.INSTANCE.onItemUseFirst(
        player,
        world,
        pos,
        side,
  ...
  override def getSize(itemStack: ItemStack) = Option(
